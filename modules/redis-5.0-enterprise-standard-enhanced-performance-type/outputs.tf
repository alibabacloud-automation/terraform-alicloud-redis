...
output "this_redis_instance_engine_version" {
  ...
  value       = module.redis.this_redis_instance_engine_version
}

output "this_redis_instance_private_ip" {
  description = "Set the instance's private IP."
  value       = module.redis.this_redis_instance_private_ip
}
...
output "this_redis_instance_backup_id" {
  ...
  value       = module.redis.this_redis_instance_backup_id
}
...
output "this_redis_instance_backup_policy_backup_period" {
  ...
  value       = module.redis.this_redis_instance_backup_policy_backup_period
}
